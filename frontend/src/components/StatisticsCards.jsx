...
const StatisticsCards = () => {
  ...
  return (
    <div className="flex gap-6 justify-between rounded-2xl">
      <InfoCard icon={<Group className="text-blue-600" />} label="Total Patients"value={counts.patients}iconBgColor="bg-blue-100"/>
      <InfoCard icon={<LocalHospital className="text-purple-600" />} label="Total Doctors"value={counts.doctors}iconBgColor="bg-purple-100"/>
      <InfoCard icon={<EventAvailable className="text-green-600" />} label="Today's Appointments"value={counts.appointments}iconBgColor="bg-green-100"/>
    </div>
  );
};
